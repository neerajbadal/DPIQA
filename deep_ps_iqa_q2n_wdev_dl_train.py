...
def ps_iqa_model(pan_shape):
    ...
    similarity_vector = tf.reduce_mean(similarity_vector,axis=1,keepdims=True)
    
    qa_model = Model(inputs=[pan_inp,ms_inp,ps_inp],
                             outputs=[similarity_vector])
...
# 
# model_optimizer = tf.keras.optimizers.Adam(4e-7,beta_1=0.6,beta_2=0.99)
# 
# checkpoint = tf.train.Checkpoint(iqa_mod)
#  
# save_dir_model = "/home/sac/dpiqa/models/"
# checkpoint_filepath = save_dir_model+"/iqa_model/"
# trial_model = "/iqa_slow_fusion_noBN_wdev_dl_contrast_2/" #running
# import os
# # os.mkdir(checkpoint_filepath)
# checkpoint_filepath = checkpoint_filepath + trial_model
# try:
...
# train_filnames = np.load(save_dir+"resnet_train_gap_wdev_sac_dl_id.npy")
# 
# train_filnames = np.array([f_nm.split('/')[-1] for f_nm in train_filnames])
# np.save("./input_numpy_files/q2n/train/"+"resnet_train_gap_wdev_sac_dl_id.npy",train_filnames)
# 
# test_filnames = np.load(save_dir+"resnet_test_gap_wv2_wdev_sac_dl_id.npy")
# 
# msinp_train_filnames = np.load(save_dir+"resnet_train_gap_wdev_sac_dl_msinp.npy")
# msinp_train_filnames = np.array([f_nm.split('/')[-1] for f_nm in msinp_train_filnames])
# np.save("./input_numpy_files/q2n/train/"+"resnet_train_gap_wdev_sac_dl_msinp.npy",msinp_train_filnames)
# 
# msinp_test_filnames = np.load(save_dir+"resnet_test_gap_wv2_wdev_sac_dl_msinp.npy")
# 
# paninp_train_filnames = np.load(save_dir+"resnet_train_gap_wdev_sac_dl_paninp.npy")
# paninp_train_filnames = np.array([f_nm.split('/')[-1] for f_nm in paninp_train_filnames])
# np.save("./input_numpy_files/q2n/train/"+"resnet_train_gap_wdev_sac_dl_paninp.npy",paninp_train_filnames)
# 
# paninp_test_filnames = np.load(save_dir+"resnet_test_gap_wv2_wdev_sac_dl_paninp.npy")
# 
# train_gt = np.load(save_dir+"resnet_train_gap_wdev_sac_dl_gt.npy")
# np.save("./input_numpy_files/q2n/train/"+"resnet_train_gap_wdev_sac_dl_gt.npy",train_gt)
# 
# test_gt = np.load(save_dir+"resnet_test_gap_wv2_wdev_sac_dl_gt.npy")
# 
# exit(0)
#                    
# tr_batch_generator = My_Custom_Generator(train_filnames,msinp_train_filnames,
#                                          paninp_train_filnames,train_gt,batch_size)
# 
...
# 
# test_batch_generator = My_Custom_Generator(test_filnames,msinp_test_filnames,
#                                          paninp_test_filnames,test_gt,70)
# 
...
if __name__ == "__main__":
    ...
    arg[3] : train_gt_numpy_file : a numpy file containing array of Q2n scores in the same index order as above input images.
    ...
    arg[8] : test_gt_numpy_file : a numpy file containing array of Q2n scores in the same index order as above input images.
    ...
    train_pansharpened_file_names_numpy_file = "./input_numpy_files/q2n/train/resnet_train_gap_wdev_sac_dl_id.npy"
    ...
    train_multispectral_file_names_numpy_file = "./input_numpy_files/q2n/train/resnet_train_gap_wdev_sac_dl_msinp.npy"
    ...
    train_panchromatic_file_names_numpy_file = "./input_numpy_files/q2n/train/resnet_train_gap_wdev_sac_dl_paninp.npy"
    ...
    train_gt_numpy_file = "./input_numpy_files/q2n/train/resnet_train_gap_wdev_sac_dl_gt.npy" 
    ...
    test_pansharpened_file_names_numpy_file = "./input_numpy_files/q2n/test/resnet_test_gap_wv3_wdev_sac_dl_id.npy"
    ...
    test_multispectral_file_names_numpy_file = "./input_numpy_files/q2n/test/resnet_test_gap_wv3_wdev_sac_dl_msinp.npy"
    ...
    test_panchromatic_file_names_numpy_file = "./input_numpy_files/q2n/test/resnet_test_gap_wv3_wdev_sac_dl_paninp.npy"
    ...
    test_gt_numpy_file = "./input_numpy_files/q2n/test/resnet_test_gap_wv3_wdev_sac_dl_gt.npy" 
    test_gt = np.load(test_gt_numpy_file)
    
    
    
    save_model_path_ = "./under_train_models/q2n_model_1/"
