...
# import os
# from Attempt2.correlation_check_scatter import sroc
...
# save_dir = "/home/sac/dpiqa/A2_PS_Data/"
# #commented on 8-jun-2022
# test_file_nm = ["resnet_test_gap_wv3","resnet_test_gap_wv2",
#                  "resnet_test_gap_wv4","resnet_test_gap_ik"]
# 
# #commented on 8-jun-2022
# file_nm = ["WorldView-3","WorldView-2",
#                 "WorldView-4","Ikonos"]
# 
# opr = "wdev_sac_dl"#used for paper v3
# 
# 
# for idx in range(0,len(test_file_nm)):
#                        
#     test_filnames = np.load(save_dir+test_file_nm[idx]+"_"+opr+"_id.npy").astype('U')
# #     test_filnames = np.array([ f_nm.split('/')[-1] for f_nm in test_filnames])
# #     np.save("./input_numpy_files/q2n/"+test_file_nm[idx]+"_"+opr+"_id.npy",test_filnames)
#     
#     
#     test_gt = np.load(save_dir+test_file_nm[idx]+"_"+opr+"_gt.npy")
# #     np.save("./input_numpy_files/q2n/"+test_file_nm[idx]+"_"+opr+"_gt.npy",test_gt)
#        
#     msinp_test_filnames = np.load(save_dir+test_file_nm[idx]+"_"+opr+"_msinp.npy")
# #     msinp_test_filnames = np.array([ f_nm.split('/')[-1] for f_nm in msinp_test_filnames])
# #     np.save("./input_numpy_files/q2n/"+test_file_nm[idx]+"_"+opr+"_msinp.npy",msinp_test_filnames)
#     
#                        
#     paninp_test_filnames = np.load(save_dir+test_file_nm[idx]+"_"+opr+"_paninp.npy")
# #     paninp_test_filnames = np.array([ f_nm.split('/')[-1] for f_nm in paninp_test_filnames])
# #     np.save("./input_numpy_files/q2n/"+test_file_nm[idx]+"_"+opr+"_paninp.npy",paninp_test_filnames)
#                        
#     
#     test_batch_generator = My_Custom_Generator(test_filnames,msinp_test_filnames,
#                                          paninp_test_filnames,test_gt,batch_size)
#                     
...
if __name__ == "__main__":
    ...
    arg[3] : gt_numpy_file : a numpy file containing array of Q2n scores in the same index order as above input images.
    ...
    image_patch_absolute_dir = "./image_patches/wv4_ct2/"
    
    pansharpened_file_names_numpy_file = "./input_numpy_files/q2n/test/resnet_test_gap_wv4_wdev_sac_dl_id.npy"
    ...
    multispectral_file_names_numpy_file = "./input_numpy_files/q2n/test/resnet_test_gap_wv4_wdev_sac_dl_msinp.npy"
    ...
    panchromatic_file_names_numpy_file = "./input_numpy_files/q2n/test/resnet_test_gap_wv4_wdev_sac_dl_paninp.npy"
    ...
    gt_numpy_file = "./input_numpy_files/q2n/test/resnet_test_gap_wv4_wdev_sac_dl_gt.npy" 
    ...
    saved_model_path_ = "./final_saved_models/q2n_model/-213"
